...
let result = [];
switch (type) {
case 'keys': result = Object.keys(object);
return result;
case 'entries': result = Object.entries(object);
return result;
case 'values': result = Object.values(object);
return result;
default: console.log('Insira um valor váildo');
break;
}
};
